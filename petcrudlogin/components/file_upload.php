...
function file_upload($picture, $source = "user")
{
    ...
    if(isset($_SESSION['adm']))$result->fileName = 'animal.png';  
        ...
        if (in_array($fileExtension, $filesAllowed)) {
            if ($fileError === 0) {
                if ($fileSize < 1000000) {
                    ...
                    $result->ErrorMessage = "This picture is bigger than the allowed 1000Kb. <br> Please choose a smaller one and Update your profile.";
                    return $result;
                }
            } else {                              
